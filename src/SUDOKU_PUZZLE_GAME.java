 ...
 * @author Rtesh kumar
 */
public class SUDOKU_PUZZLE_GAME extends javax.swing.JFrame {
    ...
    public void click(JButton btn){
        ...
        btn.setText(Number);
        HashMap<JButton,String> map =new HashMap<>();
        map.put(btn,Number);
        st.push(map);
        }
    }
...
if(JOptionPane.showConfirmDialog(this,"conform if you want to Exit","SUDOKU",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SUDOKU_PUZZLE_GAME.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SUDOKU_PUZZLE_GAME().setVisible(true);
            }
        });
    }
